...
class MultiheadAttention(nn.Module):
    ...
    Args:
        ...
        sparse_gate_class: module for sparse gate. Default: None.
    ...
    def forward(self, query, key, value, key_padding_mask=None,
        ...
        # type: (Tensor, Tensor, Tensor, Optional[Tensor], bool, Optional[Tensor], int, Optional[Tensor], bool) -> Tuple[Tensor, Optional[Tensor]]
        r"""
    Args:
        query, key, value: map a query and a set of key-value pairs to an output.
            See "Attention Is All You Need" for more details.
        ...
        cross_range: range for cross-frame interactions
        interaction_mask: mask for indicating interactions between agents in group
        seq_mask: whether mask to prevent positions from attending to subsequent positions is needed
    Shape:
        - Inputs:
        - query: :math:`(L, N, E)` where L is the target sequence length, N is the batch size, E is
          the embedding dimension.
